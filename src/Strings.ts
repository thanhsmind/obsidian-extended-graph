export default class STRINGS {
	...
	static features = {
		...
		nodeColorsDesc: "Choose the color of the nodes based on a statistic.",
		...
		nodeSizesPropertyDesc: "Name of the property used to specify the size of the node. It must be of type number. A value of ${NodeShape.RADIUS} is the default. Leave empty if you don't need a per-node granularity.",
