export default class STRINGS {
	...
	static controls = {
		...
		edit: "Edit",
		enable: "Enable",
		enableInGraphView: "Enable in graph view",
		disableInGraphView: "Disable in graph view",
		resetInGraphView: "Reset in graph view",
		enabled: "Enabled",
		...
		importSettingsAndReload: "Import settings and reload",
		...
		override: "Override",
		overrideConfig: "Override an existing configuration",
		orCreateCongig: "Or create a new one",
		page: "Page",
		...
		reverse: "Reverse",
		save: "Save",
		selectConfigToImport: "Select a configuration to import",
		setConfigName: "Set configuration name",
		show: "Show",
		toggle: "Toggle",
	...
	static features = {
		...
		animateDotsOnLinksSpeed: "Animation speed",
		animateDotsOnLinksSpeedDesc: "Speed of the animation of the dots on links",
		arrows: "Arrows",
		arrowsDesc: "Customize how arrows are displayed",
		arrowsColoredFronLinks: "Color from links",
		arrowsColoredFromLinksDesc: "Use the links colors for the arrows",
		arrowsColor: "Custom color",
		arrowsColorDesc: "Pick a custom color for the links arrows",
		arrowsInvert: "Invert arrows",
		arrowsInvertDesc: "Invert the direction of the arrows on the links",
		arrowsFixedSize: "Fixed size",
		arrowsFixedSizeDesc: "Prevent the arrows to scale down or up when zooming",
		...
		arrowsOpaqueAlways: "Always",
		arrowsOpaqueKeepFading: "Only when zoomed",
		arrowsScale: "Scale",
		arrowsScaleDesc: "Increase or decrease the scale of arrows",
		...
		excludeSourceFoldersDesc: "Exclude forward links with source inside some folders (i.e. links coming out one of these folders)",
		excludeTargetFolders: "Exclude target folders",
		...
		iconPropertiesDesc: "Keys (names) of the properties that can be used to query the icon of the node's note. Supported values in the frontmatter can be either unicode emojis or Lucide icon identifiers.",
		iconPropertiesAdd: "Add icon property",
		...
		imagePropertiesDesc: "Names of the properties that can be used to query the image of the node's note",
		imagePropertiesAdd: "Add image property",
		...
		interactives: {
			...
			arcWeight: "Weight arc length",
			arcWeightDesc: "Use the number of time the value is found to determine arcs lengths (requires 'Spread arcs' to be enabled)",
			...
			displayLinkTypeLabelDesc: "Display the type label on top of the link",
			links: "Links",
		...
		namesUseProperties: "Use properties",
		namesUsePropertiesDesc: "Use one of the desired properties as the node name instead of the filename",
		namesUsePropertiesAdd: "Add node name property",
		...
		nodeSizeProperties: "Node size properties",
		nodeSizePropertiesDesc: "Names of the properties that can be used to specify the size of the node. They must be of type number. A value of 100 is the default.",
		nodeSizePropertiesAdd: "Add node size property",
